...
public class RedisController {
    ...
    // 添加数据到redis http://localhost:8080/redis/addstring   通过postman在body中传参
    ...
    // 从redis获取数据     http://localhost:8080/redis/getk?key=test
    ...
    @GetMapping("/redis/{k}")  // http://localhost:8080/redis/test
